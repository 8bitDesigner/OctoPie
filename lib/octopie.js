...
Octopie.prototype._configureHooks = function(configureCallback) {
  var _this = this;
  ...
  async.map(_this.repos, function(repo, cb) {
    ...
    configureCallback(null, results);
  });
}
...
Octopie.prototype.listen = function(port) {
  ...
  this._configureHooks(function (err, hooks) {
    if (err)
      throw new Error('Failed to configure hooks');
